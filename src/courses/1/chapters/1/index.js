      ...
      html: (
        <div className="Introduction">
          ...
          <div className="Introduction-part">
            ...
            <div className="Introduction-part-content">
              <p>
              The main reason the normal distribution is useful is because of the Central Limit Theorem, which in short, states: even if we do not know the real distribution for a random variable X, the sample distribution of its mean will in many cases act in a way that resembles the normal distribution, as long as the sample size is large enough.
              This property is one of the reasons that the normal distribution is commonly used to describe the behaviour of certain subjects in various sciences, such as biology, physics, astronomy and finance.
              </p>
              <p>Secondly, the normal distribution is also very easy to use. Here are a few points explaining why:
              </p>
                <ul>
                  <li>
                  Its probability density function depends only on the expectation and standard deviation of the random variable of the distribution.
                  Since the expectation and standard deviation are rather easy to calculate, so is the probability density.
                  </li>
                  <li>
                  It is symmetrical.
                  This often means that when calculating various probability densities sometimes it is enough to only calculate one half of the distribution.
                  </li>
                  <li>
                  It has a standard which it can be translated into. This is called the standard normal distribution. The standard normal distribution has a table where the cumulative probability for a large range of values is already calculated. This means that it is not always necessary to calculate this by hand.
                  Instead, it can be looked up in the table, speeding up the process considerably.
                  </li>
              </p>
            </div>
          </div>
          ...
          <div className="Introduction-part">
            ...
            <div className="Introduction-part-content">
              ...
              <p>
                Since the area under the probability density function should always be equal to 1,
                it implicates that <TeX data={'\int_{-\infty}^{\infty}{\frac{1}{\sqrt(2\pi\sigma)}e^{1/2((x-\mu/)\sigma)^2}}'}/>
                The link to the proof for this is given here: [link to proof]. 
              </p>
              <p>
                As you can see, the probability density function of the normal distribution requires
                only that mu is a real number and sigma is positive. And as you may already suspect, mu and
                sigma corresponds to the expectation and standard deviation of the normal random variable.
              </p>
              <p>
                The graph of the density function of the normal random variable is symmetric,
                with the expectation mu in its center. At <TeX data={'\mu\pm\sigma'}/>, one can find the points of inflection.
              </p>
            </div>
          </div>
          ...
          <div className="Introduction-part">
            ...
            <div className="Introduction-part-content">
              ...
              <b>Example</b>:
                \n
                Say we are conducting an experiment where we wish to know
                how the weight of children in Sweden is distributed.
                \n
                Now, we don’t know the real distribution of the weight of children in Sweden,
                thus we name a random variable X, which we imagine, contains all the possible weights for children in Sweden.
                \n
                We call a specific weight in the random variable X, x (Note the lowercase). 
                \n
                Each specific x in X also has a probability associated with it,
                which we call P(x), which describes the chance for any randomly chosen child to have the weight x. 
                \n
                To find an approximation to P(x) for all possible x, a random sample
                size of 10 000 weights of different children are measured during the experiment. 
                \n
                We can now use this random sample to work out the probability for every
                x measured, by dividing the frequency of each x by our total sample size. Note that we
                can by no means work out the exact value of the real P(x) (which is associated the entire
                population of children in Sweden), however, since our sample size is rather large, we deem it
                a good enough approximation to the real P(X). 
                \n
                By graphing P(x) on the vertical axis and each x on the horizontal axis,
                we can see the distribution of our random sample. The shape of this graph may look something alike a
                bell-shape. If it does, we can conclude that the weights of children are normal distributed.
              </p>
          ...
          <div className="Introduction-part">
            ...
            <div className="Introduction-part-content">
              ...
              <p>
              This describes the expectation from the random variable X.
              The expectation is the value of X that is most probable.
              </p>            
              
              <h4>X - Random variable</h4>
              <p>
              A random variable is a variable that can assume many different values, x. For each x in X,
              there is a probability P(X = x) which describes the probability
              the random variable X assumes the value x
              </p>
              
              <h4>x - specific value of X</h4>
              <p>
              This is a specific value of the random variable X. 
              </p>          
              
              <h4>P(X = x) - Probability for x</h4>
              <p>
              This describes the probability that the random variable X assumes the value x. 
              </p>
            </div>
          </div>
