...
export default () => (
  <div>
    <div className="Experiment-part">
      ...
      <p>The first step of a statistical experiment is deciding on the subject to experiment on. The subject must fulfill these points in order for such an experiment to be successful:
      </p>
    ...
    <div className="Experiment-part">
      ...
      <p>In this specific experiment, the subject we choose to observe is the height of different human individuals. It can be narrowed down even further by defining a gender, nationality or age. However we will not do that in this experiment, instead we will compare the heights of people despite of their background or gender.</p>
    ...
    <div className="Experiment-answer">
      Answer:
      <ol className="Experiment-listMargin">
        <li>The subject has an unlimited amount of different outcomes between 0 and infinity.</li>
        <li>It can be repeated indefinitely as long as there’s enough people to measure</li>
        <li>Each outcome can be determined, we know that a person’s height should probably be between 0 and 250 cm. Let’s set the maximum to 300 cm.</li>
        <li>The outcome of the subject is actually dependent many different factors such as genetics, environment, etc. However, all factors combined are so complex that it may be considered to be dependent on probability.</li>
      </ol>
    </div>
